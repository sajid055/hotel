...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">fs741142@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 70 66 09 29 27</li>	
					<li class="s-bar">
						<div class="search">
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 91 75255173</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">SAJIDANSARI83451@GMAIL.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> New Mohammadali Road, Nashik, Maharashtra, India</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2024 SUNRISE . All Rights Reserved | Design by <a href="index.php">S.F BUILDCON</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
